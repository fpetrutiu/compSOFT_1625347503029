...
function getConnection() {
	...
	global $db_compSOFT_db_Url, $db_compSOFT_db_User, $db_compSOFT_db_Pass, $db_compSOFT_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_compSOFT_db_Url.";dbname=".$db_compSOFT_db_DbName, $db_compSOFT_db_User, $db_compSOFT_db_Pass);
