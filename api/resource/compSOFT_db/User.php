...
$app->post('/user',	function () use ($app){
	...
	$params = array (
		...
		'companyID' => isset($body->companyID)?$body->companyID:'',
	);

	$obj = makeQuery("INSERT INTO user (_id, mail, name, password, roles, surname, username , companyID )  VALUES ( null, :mail, :name, :password, :roles, :surname, :username , :companyID   )", $params, false);
...
$app->post('/user/:id',	function ($id) use ($app){
	...
	$obj = makeQuery("UPDATE user SET  mail = :mail,  name = :name,  password = :password,  roles = :roles,  surname = :surname,  username = :username  , companyID=:companyID  WHERE _id = :id LIMIT 1", $params, false);
